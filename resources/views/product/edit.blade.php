                ...
                <div class="p-6 text-gray-900 dark:text-gray-100">
                    <form method="POST" action="{{ route('products.update', $product->id) }}" enctype="multipart/form-data">
                        ...
                        <div class="grid grid-cols-1 gap-6 sm:grid-cols-2">
                            <div>
                                <label for="name_en" class="block text-sm font-medium text-gray-700 dark:text-gray-300">Name (EN)</label>
                            ...
                            <div>
                                <label for="name_jp" class="block text-sm font-medium text-gray-700 dark:text-gray-300">Name (JP)</label>
                            ...
                            <div>
                                <label for="description_jp" class="block text-sm font-medium text-gray-700 dark:text-gray-300">Description (JP)</label>
                                <textarea name="description_jp" id="description_jp" rows="4" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm" required>{{ old('description_jp', $product->translations->where('locale', 'jp')->first()->description) }}</textarea>
                        ...
                        <div class="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 gap-6 mt-6">  
                            ...
                            <div class="relative group overflow-hidden rounded-lg shadow-lg border border-gray-300 hover:shadow-xl transition-shadow duration-300">
                                <!-- Image -->
                                <img src="{{ asset('storage/' . $product->product_image) }}" alt="Product Image" class="w-full h-48 object-cover transition-transform duration-300 group-hover:scale-110">
                        ...
                        <p class="mt-2 text-sm text-gray-500 dark:text-gray-400">Allowed file types: jpeg, png, jpg. Maximum file size: 5 MB per image. You can select multiple images.</p>
                        <!-- Additional Images -->
                        <div class="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 gap-6 mt-6">  
                            ...
                            @foreach($images as $image)
                                <div class="relative group overflow-hidden rounded-lg shadow-lg border border-gray-300 hover:shadow-xl transition-shadow duration-300">
                                    <!-- Image -->
                                    <img src="{{ asset('storage/' . $image->image_url) }}" alt="Product Image" class="w-full h-48 object-cover transition-transform duration-300 group-hover:scale-110">
