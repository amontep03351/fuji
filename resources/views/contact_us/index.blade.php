<x-app-layout>
        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="bg-white white:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900 white:text-gray-100">
                    <form id="contactForm" action="{{ route('contactus.update') }}" method="POST">
                        @csrf
                        @method('PUT')
                        ...
                        <!-- Map Location 1 -->
                        <div class="mb-6">
                            <label for="map_location_1" class="block text-sm font-medium text-gray-700">Map Location 1 (Google Maps URL)</label>
                        ...
                        <!-- Map Location 2 -->
                        <div class="mb-6">
                            <label for="map_location_2" class="block text-sm font-medium text-gray-700">Map Location 2 (Google Maps URL)</label>
                        ...
                        <div class="mb-6">
                            ...
                            <input type="text" id="mail_1" name="mail_1" value="{{ old('mail', implode(', ', json_decode($contactUs->mail, true) ?? [])) }}" class="mt-1 block w-full border-gray-300 rounded-md shadow-sm">
                        ...
                        <div class="mb-6">
                            ...
                            <input type="text" id="tel_1" name="tel_1" value="{{ old('tel', implode(', ', json_decode($contactUs->tel, true) ?? [])) }}" class="mt-1 block w-full border-gray-300 rounded-md shadow-sm">
                        ...
                        <div class="mb-6">
                            ...
                            <input type="url" id="facebook_link_1" name="facebook_link_1" value="{{ old('linkfacebook', $contactUs->linkfacebook) }}" class="mt-1 block w-full border-gray-300 rounded-md shadow-sm">
                        </div>

                        <!-- YouTube Link -->
                        <div class="mb-6">
                            <label for="youtube_link_1" class="block text-sm font-medium text-gray-700">YouTube Link</label>
                            <input type="url" id="youtube_link_1" name="youtube_link_1" value="{{ old('linkyoutube', $contactUs->linkyoutube) }}" class="mt-1 block w-full border-gray-300 rounded-md shadow-sm">
                        </div>
    ...
    <script>
        // Initialize CKEditor for the address fields
        ClassicEditor
            .create(document.querySelector('#address_en_1'))
            .catch(error => {
                console.error('There was a problem initializing the editor for Address EN 1:', error);
            });

        ClassicEditor
            .create(document.querySelector('#address_en_2'))
            .catch(error => {
                console.error('There was a problem initializing the editor for Address EN 2:', error);
            });

        ClassicEditor
            .create(document.querySelector('#address_jp_1'))
            .catch(error => {
                console.error('There was a problem initializing the editor for Address JP 1:', error);
            });

        ClassicEditor
            .create(document.querySelector('#address_jp_2'))
            .catch(error => {
                console.error('There was a problem initializing the editor for Address JP 2:', error);
            });
    </script>
</x-app-layout>
