<nav x-data="{ open: false }" class="bg-white white:bg-gray-800 border-b border-gray-100 white:border-gray-700">
        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="shrink-0 flex items-center">
                    <a href="{{ route('cwwebadmin') }}">
                        <img src="{{ asset('public/build/assets/logo.png') }}" alt="Logo" class="block h-9 w-auto"/>
                    </a>
                </div>

                <!-- Navigation Links -->
                <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                    <x-nav-link :href="route('cwwebadmin')" :active="request()->routeIs('cwwebadmin')">
                        {{ __('Dashboard') }}
                    </x-nav-link>
                    ...
                    <x-nav-link :href="route('contactus.edit')" :active="request()->routeIs('contactus.edit')">
                        {{ __('Contact Us') }}
                    </x-nav-link>
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        <div class="pt-2 pb-3 space-y-1">
            <x-responsive-nav-link :href="route('cwwebadmin')" :active="request()->routeIs('cwwebadmin')">
                {{ __('Dashboard') }}
            ...
            <x-responsive-nav-link :href="route('contactus.edit')" :active="request()->routeIs('contactus.edit')">
                {{ __('Contact Us') }}
            </x-responsive-nav-link>
        </div>
